...
<body>
    <div class="center">
        ...
        $id=$_GET['id'];
        $sql = "SELECT `id`, `image1`, `image2`, `image3`, `price`, `duration`, `place_name`,`departure_place`,`departure_date`, `link` FROM `international_package` WHERE `id` = $id";
    ...
    <form method="post" action="aadhaar_i.php">
